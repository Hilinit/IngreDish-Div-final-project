...
const NotFound = ({ message, to = -1 }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-slate-600 dark:text-gray-400 gap-4 bg-gray-50 dark:bg-neutral-950 transition-colors">
